...
def aggregate(speakers_to_analyze, raw_speeches, speechid_to_speaker, Girondins, Montagnards, Plein):
	...
	write_to_excel(df_girondins, "Girondins_counts_withlimit_morethan5speaker.xlsx")
	...
	write_to_excel(df_montagnards, "Montagnards_counts_withlimit_morethan5speaker.xlsx")
	...
	write_to_excel(df_combined, 'combined_frequency_withlimit_morethan5speaker.xlsx')
